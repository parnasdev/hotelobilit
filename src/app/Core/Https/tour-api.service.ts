...
export class TourApiService {
  ...
  getTours(pageNum?: number, status_id: string = '',origin:string = '',destination:string = ''): any {
    const address = `panel/tours?page=${pageNum}&status=${status_id}&origin=${origin}&destination=${destination}`;
